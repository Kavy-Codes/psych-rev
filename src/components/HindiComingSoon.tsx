  ...
  return (
    <div className="min-h-[100dvh] flex flex-col items-center justify-center px-6 py-10 bg-zinc-950">
      <div className="text-center animate-slide-up">
        ...
        <h1 className="text-white font-black text-2xl mb-2">हिंदी (ऐच्छिक)</h1>
        ...
        <p className="text-zinc-400 text-xs mb-8 max-w-xs mx-auto leading-relaxed">
          अंतरा भाग-2 (काव्य + गद्य) और अंतराल — फ्लैशकार्ड्स, क्विज़, नोट्स, माइंड मैप्स और बहुत कुछ।
        </p>

        {/* What's coming */}
        <div className="w-full max-w-xs space-y-2 mb-8">
          {[
            { emoji: '🃏', text: '75 फ्लैशकार्ड्स — पाठ-वार महत्वपूर्ण तथ्य' },
            { emoji: '📝', text: '34 क्विज़ प्रश्न — MCQ, A-R, केस-स्टडी' },
            { emoji: '📖', text: '25 पाठों के सारांश — परीक्षा-केंद्रित' },
            { emoji: '🔤', text: 'व्याकरण पद — अलंकार, छंद, समास' },
            { emoji: '✍️', text: 'लेखन प्रारूप — निबंध, पत्र, विज्ञापन' },
            { emoji: '🗺️', text: 'माइंड मैप्स — 25 पाठों के वृक्ष' },
